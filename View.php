...
if($DBConnect == false)
	print"Unable to connect to the database:" .mysqli_errno();
		...
		$department = mysqli_fetch_assoc($QueryResult);
...
<ul>
	<li>
		<b>dept_id: </b> <?php echo $department['dept_id']?>
	</li><br/>
		<li>
		<b>dept_name: </b> <?php echo $department['dept_name']?>
	</li><br/>
	</li>
</ul></h4>
</html>